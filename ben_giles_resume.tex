...
\section{Analysis and Development Experience}
  \resumeSubHeadingListStart
    \resumeSubItem{Languages}{Python, C99, C++14, x86 ASM, Lua, SQL, Java, MATLAB, Perl, LaTeX, Bash, PowerShell, .NET.}
    \resumeSubItem{Tools}{gcc/ld/gdb, make, nasm, coreutils, git, vim, ESRI SDK's, Visual Studio, JetBrains, IDA Pro, x64gdb, WireShark, Linux, Windows Server}
    \resumeSubItem{Programming practice}{version control, DevOps, UML, CI/CD, pair programming, code review}
    \resumeSubItem{Leedership}{Mentoring, tasking, reporting, course delivery, hiring, management, agile processes}
    \resumeSubItem{Applications}{Linux system and network programming, geographic information systems, algorithm development, operations research, machine learning, database development}
      ...
      {Cyber Security (Advanced Tradecraft)}{Feb 2020 - July 2020}
        \resumeItemListStart
          \resumeItem{Post-graduate Coursework}
            {Reverse Engineering, Information Security Engineer, IoT and Wireless Security, Digital Forensics}
          \resumeItemListEnd
