...
\section{Technical Skills}
  \resumeSubHeadingListStart
    \resumeSubItem{Technologies}
      {: AWS/GCP: (datastores, load balancers, orchestration, security profiles, compute, analytics), RDBMS, OpenGL, scientific Python, Unix.}
    \resumeSubItem{Recently used languages}{: Python, C, SQL, Java, MATLAB, Bash.}
    \resumeSubItem{Techniques}{: version control, machine learning, scientific Python, operating system internals, low level systems and network programing, geographic information systems, applied mathematics, statistics, mentoring and instruction.}
...
\section{Recent Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Post-graduate coursework}{Canberra, Australia}
      {ADFA @ UNSW Canberra}{Feb 2020 - July 2020}
        \resumeItemListStart
          \resumeItem{Advanced Tradecraft}
            {Australian Signals Directorate Information Security practices, Reverse Engineering, Offensive Electronic Warfare Techniques, Digital Forensics, Exploit Development}
          \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
          {Delivered software consulting and development services to oil \& gas and fintech sectors.}
            ...
            \resumeItem{PlayerQwikVol, with GIS-Pax Pty Ltd}
...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Master of Computing in Distributed Systems;  GPA: 3.9/4}{Mar. 2011 -- Dec. 2014}
    \resumeSubheading
